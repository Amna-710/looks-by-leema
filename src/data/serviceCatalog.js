...
export const SERVICE_IMAGES = {
  ...
  facials: {
    'Basic Cleanup Facial': img('facials', 'basic-cleanup-facial.jpg'),
    'Hydrating Facial': img('facials', 'hydrating.png'),
    'Brightening Facial': img('facials', 'brightening-facial.jpg'),
    'Acne Treatment Facial': img('facials', 'acne-treatment-facial.jpg'),
    'Anti-Aging Facial': img('facials', 'anti-aging.png'),
    'Bridal Glow Facial': img('facials', 'bridal-glow-facial.jpg'),
  },
  waxing: {
    'Full Body Wax': img('waxing', 'full-body-wax.jpg'),
    'Full Legs': img('waxing', 'legs.png'),
    'Half Legs': img('waxing', 'half-legs.jpg'),
    'Full Arms': img('waxing', 'full-arms.jpg'),
    'Half Arms': img('waxing', 'half-arms.jpg'),
    Underarms: img('waxing', 'underarms.jpg'),
    Brazilian: img('waxing', 'brazilian.jpg'),
    'Bikini Line': img('waxing', 'bikini-line.jpg'),
    Stomach: img('waxing', 'stomach.jpg'),
    Back: img('waxing', 'back.jpg'),
    'Full Face': img('waxing', 'face.png'),
    Eyebrows: img('waxing', 'eyebrow.png'),
    'Upper Lip': img('waxing', 'upper-lip.jpg'),
  },
  nails: {
    'Basic Manicure': img('nails', 'basic-manicure.jpg'),
    'Basic Pedicure': img('nails', 'basic-pedicure.jpg'),
