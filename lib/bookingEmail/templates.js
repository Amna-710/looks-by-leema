...
export function buildBookingConfirmedEmail(booking) {
  ...
  const bodyHtml = `
    ...
    ${buildDetailsTable({ serviceName, date, time })}
    <p style="margin:0 0 16px;font-size:16px;line-height:1.8;color:#444444;">
      We can’t wait to welcome you! If you need to make any changes, simply reply to this email or contact our team.
    </p>
    <p style="margin:0;font-size:16px;line-height:1.8;color:#444444;">
      See you soon! 💕<br><br>Best regards,<br><strong style="color:#B76E79;">Looks By Leema Team</strong>
    </p>`;

  return {
    subject: 'Your Appointment Is Confirmed ✨',
    html: buildEmailShell({ title: 'Appointment Confirmed', statusLabel: 'Confirmed', statusTone: 'confirmed', bodyHtml }),
    text: `Hi ${customerName},\n\nYour appointment at Looks By Leema has been confirmed!\n\nService: ${serviceName}\nDate: ${date}\nTime: ${time}\n\nBest regards,\nLooks By Leema Team`,
  };
}
